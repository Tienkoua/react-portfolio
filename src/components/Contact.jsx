      ...
      bg-gradient-to-b from-black to-gray-800 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/85f8ba42-9fbf-44a3-b816-52186219d525" method='POST'
                    ...
                    <textarea placeholder='Enter your message' name="message" rows="10" className='p-2  bg-transparent border-2 rounded-md text-white
